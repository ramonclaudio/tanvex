...
| Avatar        | `avatar.tsx`        | Always `rounded-full`. Sizes used: `size-8` (header chip), `size-9` (icon button), `size-14` (signup picker), `size-24` (profile hero). Fallback is a user glyph in `bg-muted` (camera glyph in the signup picker).                                                                                                                                                                               |
